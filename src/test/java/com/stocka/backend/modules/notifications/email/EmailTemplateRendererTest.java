...
class EmailTemplateRendererTest {
    ...
    class SharedLayout {
        ...
        void invitation_should_useGenericFooter_inEn() {
            ...
            // Thymeleaf escapes the apostrophe to &#39; inside th:text (vs th:utext) — match a substring without it.
            assertTrue(rendered.htmlBody().contains("receiving this email because you have a Stocka account"),
        ...
        void invitation_should_useGenericFooter_inCa() {
            ...
            assertTrue(rendered.htmlBody().contains("Has rebut aquest correu perquè tens un compte a Stocka"),
